  ...
  return (
    <div>
      <div className=" grid mt-2 gap-2 grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
                <label className=" p-4 flex rounded-2xl gap-2 items-center cursor-pointerborder-solid border-2 border-gray-400  ">
                ...
                <label className=" p-4 flex rounded-2xl gap-2 items-center cursor-pointer border-solid border-2 border-gray-400 ">
